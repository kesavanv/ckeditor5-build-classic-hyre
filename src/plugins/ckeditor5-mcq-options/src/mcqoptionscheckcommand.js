...
/**
 * @module list/mcqoptionscheckedcommand
 */

import Command from '@ckeditor/ckeditor5-core/src/command';

const attributeKey = 'mcqOptionsChecked';

/**
 * The to-do check command.
 *
 * The command is registered by the {@link module:list/mcqoptionsediting~McqOptionsEditing} as
 * the `'mcqOptionsCheck'` editor command.
 *
 * @extends module:core/command~Command
 */
export default class McqOptionsCheckCommand extends Command {
	/**
	 * @inheritDoc
	 */
	constructor( editor ) {
	...
	refresh() {
		...
		this.value = this._selectedElements.every( element => !!element.getAttribute( 'mcqOptionsChecked' ) );
